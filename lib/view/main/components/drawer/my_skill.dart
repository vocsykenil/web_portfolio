  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.60, title: 'Sqlite',image: 'assets/icons/dart.png'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.80, title: 'Getx',image: 'assets/icons/dart.png'),
      ],);
  }
}
